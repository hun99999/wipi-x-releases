...
이 문서는 0.1.22 테스트 앱의 사용 흐름을 설명합니다. **0.1.22 (Alpha)**는 2026년 9월 15일 오전 9:13부터 Google Play 알파 테스터에게 제공 중입니다. Play Console의 제공 상태를 확인했습니다. Android 8.0 이상이 필요하며, 앱 설치와 업데이트는 Google Play에서 제공합니다. [테스트 참여 안내](TESTING.md)에 따라 그룹 가입과 Play 테스트 참여를 마친 뒤 설치하세요.
