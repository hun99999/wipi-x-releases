...
이 문서는 0.1.0 테스트 앱의 사용 흐름을 설명합니다. Android 8.0 이상이 필요하며, 앱 설치와 업데이트는 Google Play에서 제공합니다. 2026년 9월 8일 첫 비공개 테스트의 심사를 요청했고 실제 설치 가능 여부는 아직 확인 전입니다. [테스트 참여 안내](TESTING.md)에서 가입 순서를 확인하세요.
...
Version 0.1.0 was submitted for closed-test review on September 8, 2026. Installation availability has not yet been verified. Follow the [testing guide](TESTING.md#english) and install through Google Play once the test is available. Android 8.0 or later is required.
