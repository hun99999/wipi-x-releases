...
**0.1.4 비공개 테스트(Alpha)를 제공합니다.** 2026년 9월 10일 기준, 아래 참여 절차를 마친 테스트 대상 사용자가 Google Play에서 설치할 수 있습니다.
...
- 앱 버전은 0.1.4이며, 공식 설치와 업데이트는 Google Play에서 제공합니다.
...
The **0.1.4 closed test (Alpha)** is available to eligible testers as of September 10, 2026. Complete the group membership and Play opt-in steps below before installing through Google Play.
