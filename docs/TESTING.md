...
**0.1.8 비공개 테스트(Alpha)를 2026년 9월 12일 심사 요청했습니다.** Play 제공은 대기 중입니다. 현재 제공이 확인된 버전은 **0.1.7**이며, 아래 참여 절차로 설치한 뒤 새 버전 반영 후 업데이트해 주세요.
...
- 현재 제공 확인 버전은 0.1.7이며 0.1.8은 제공 대기 중입니다. 공식 설치와 업데이트는 Google Play에서 제공합니다.
...
**0.1.8 (Alpha)** was submitted for review on September 12, 2026, and Play availability is pending. **0.1.7** remains the version confirmed available; update after the new build reaches Play. Complete the group membership and Play opt-in steps below before installing through Google Play.
