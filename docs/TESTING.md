...
**0.1.29 (Alpha)**는 2026년 9월 15일 오후 6:37부터 Google Play 알파 테스터에게 제공 중입니다. Play Console의 제공 상태를 확인했습니다. 아래 참여 절차로 설치하거나 기존 앱을 업데이트해 주세요.
...
- 현재 제공 확인 버전은 0.1.29 Alpha입니다. 공식 설치와 업데이트는 Google Play에서 제공합니다.
...
**0.1.29 (Alpha)** is available to Google Play Alpha testers as of September 15, 2026 at 18:37 KST, confirmed in Play Console. Complete the group membership and Play opt-in steps below before installing through Google Play.
