...
> **최신 기록 · 0.1.33 Alpha / Play 제공 중** — [WIPI-X 0.1.33 — 리듬스타 타이머 동작 복원](https://github.com/hun99999/wipi-x-releases/releases/tag/v0.1.33) · [전체 릴리즈 보기](https://github.com/hun99999/wipi-x-releases/releases)
...
**WIPI-X 앱의 공식 설치와 업데이트는 Google Play에서만 제공합니다.** **0.1.33 (Alpha)**는 2026년 9월 15일 오후 11:11부터 Google Play 알파 테스터에게 제공 중입니다. Play Console의 제공 상태를 확인했습니다. 기존 앱을 삭제하지 않고 Google Play에서 업데이트할 수 있습니다.
...
- **0.1.33 리듬스타 타이머 동작 복원:** 리듬스타(KTF)의 이전 타이머 동작을 복원했고 직접 플레이에서 싱크가 정상으로 느껴졌다는 피드백을 받았습니다. 기존 저장·설정·게임 ZIP과 지원 판정 12개를 유지합니다.
...
게임은 오프라인으로 실행하며 로그인·광고·인앱 결제 없이 동작합니다. 앱 시작과 수동 업데이트 확인에는 GitHub 공개 릴리스 조회를 위한 인터넷 연결을 사용합니다. 기기와 게임에 따라 실행·저장 범위와 배속 성능은 다를 수 있습니다. [0.1.33 변경 안내](docs/UPDATES.md)에서 이번 테스트 버전의 내용을 확인할 수 있습니다.
...
The app is distributed **exclusively through Google Play**. **0.1.33 (Alpha)** is available to Google Play Alpha testers as of September 15, 2026 at 23:11 KST, confirmed in Play Console. Join the testers group and opt in using the same Google account. See the [testing guide](docs/TESTING.md#english) and [release notes](https://github.com/hun99999/wipi-x-releases/releases).

Version 0.1.33 restores the previous timer behavior for Rhythm Star (KTF), with direct-play feedback that sync felt normal after the rollback. Existing saves, settings, game ZIPs and twelve Supported game files remain compatible.
