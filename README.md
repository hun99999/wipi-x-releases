...
> **최신 기록 · 0.1.28 Alpha / Play 제공 중** — [WIPI-X 0.1.28 — 게임 호환성과 실행 성능 개선](https://github.com/hun99999/wipi-x-releases/releases/tag/v0.1.28) · [전체 릴리즈 보기](https://github.com/hun99999/wipi-x-releases/releases)
...
**WIPI-X 앱의 공식 설치와 업데이트는 Google Play에서만 제공합니다.** **0.1.28 (Alpha)**는 2026년 9월 15일 오후 3:58부터 Google Play 알파 테스터에게 제공 중입니다. Play Console의 제공 상태를 확인했습니다. 기존 앱을 삭제하지 않고 Google Play에서 업데이트할 수 있습니다.
...
- **0.1.28 호환·성능 개선:** 테일즈위버 3편을 더해 지원 판정 파일을 12개로 늘렸습니다. 미니게임천국2의 갱신 간격, 일부 게임의 실행 성능과 이노티아2의 시작 문제를 보완했습니다.
...
게임은 오프라인으로 실행하며 로그인·광고·인앱 결제 없이 동작합니다. 앱 시작과 수동 업데이트 확인에는 GitHub 공개 릴리스 조회를 위한 인터넷 연결을 사용합니다. 기기와 게임에 따라 실행·저장 범위와 배속 성능은 다를 수 있습니다. [0.1.28 변경 안내](docs/UPDATES.md)에서 이번 테스트 버전의 내용을 확인할 수 있습니다.
...
The app is distributed **exclusively through Google Play**. **0.1.28 (Alpha)** is available to Google Play Alpha testers as of September 15, 2026 at 15:58 KST, confirmed in Play Console. Join the testers group and opt in using the same Google account. See the [testing guide](docs/TESTING.md#english) and [release notes](https://github.com/hun99999/wipi-x-releases/releases).

Version 0.1.28 expands Supported status to twelve exact game files with three TalesWeaver editions, improves MiniGame Paradise 2 timing and execution performance in some games, and fixes Inotia 2 startup. Existing game ZIPs remain usable.
