...
> **최신 기록 · 0.1.31 Alpha / Play 제공 중** — [WIPI-X 0.1.31 — 짧은 소리의 끝부분 재생 개선](https://github.com/hun99999/wipi-x-releases/releases/tag/v0.1.31) · [전체 릴리즈 보기](https://github.com/hun99999/wipi-x-releases/releases)
...
**WIPI-X 앱의 공식 설치와 업데이트는 Google Play에서만 제공합니다.** **0.1.31 (Alpha)**는 2026년 9월 15일 오후 8:15부터 Google Play 알파 테스터에게 제공 중입니다. Play Console의 제공 상태를 확인했습니다. 기존 앱을 삭제하지 않고 Google Play에서 업데이트할 수 있습니다.
...
- **0.1.31 짧은 소리의 끝부분 재생 개선:** 마지막 짧은 소리가 끝까지 출력되지 않던 문제를 수정하고 이노티아2 타이틀과 미니게임천국2의 짧은 라운드를 확인했습니다. 기존 저장·설정·게임 ZIP과 지원 판정 12개를 유지합니다.
...
게임은 오프라인으로 실행하며 로그인·광고·인앱 결제 없이 동작합니다. 앱 시작과 수동 업데이트 확인에는 GitHub 공개 릴리스 조회를 위한 인터넷 연결을 사용합니다. 기기와 게임에 따라 실행·저장 범위와 배속 성능은 다를 수 있습니다. [0.1.31 변경 안내](docs/UPDATES.md)에서 이번 테스트 버전의 내용을 확인할 수 있습니다.
...
The app is distributed **exclusively through Google Play**. **0.1.31 (Alpha)** is available to Google Play Alpha testers as of September 15, 2026 at 20:15 KST, confirmed in Play Console. Join the testers group and opt in using the same Google account. See the [testing guide](docs/TESTING.md#english) and [release notes](https://github.com/hun99999/wipi-x-releases/releases).

Version 0.1.31 fixes playback of the final portion of short sounds, with the Inotia 2 title ending and a short MiniGame Paradise 2 round checked. Existing saves, settings, game ZIPs and twelve Supported game files remain compatible.
