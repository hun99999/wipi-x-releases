...
> **최신 기록 · 0.1.22 Alpha / Play 심사 요청** — [WIPI-X 0.1.22 — 호환·저장·터치 조작 개선](https://github.com/hun99999/wipi-x-releases/releases/tag/v0.1.22) · [전체 릴리즈 보기](https://github.com/hun99999/wipi-x-releases/releases)
...
**WIPI-X 앱의 공식 설치와 업데이트는 Google Play에서만 제공합니다.** **0.1.22 (Alpha)**는 2026년 9월 15일 심사 전송을 요청했습니다. Play 자동 검사 진행 중이며 제공은 대기 중입니다. 현재 제공이 확인된 버전은 **0.1.11**입니다. 새 버전이 반영되면 기존 앱에서 업데이트할 수 있습니다.
