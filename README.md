...
> **최신 기록 · 0.1.28 Alpha / Play 제공 대기** — [WIPI-X 0.1.28 — 게임 호환성과 실행 성능 개선](https://github.com/hun99999/wipi-x-releases/releases/tag/v0.1.28) · [전체 릴리즈 보기](https://github.com/hun99999/wipi-x-releases/releases)
...
**WIPI-X 앱의 공식 설치와 업데이트는 Google Play에서만 제공합니다.** **0.1.28 (Alpha)**는 심사 요청을 완료했으며 Play 제공을 기다리고 있습니다. 현재 제공이 확인된 버전은 **0.1.22**입니다. 기존 앱을 삭제하지 않고 Google Play에서 업데이트할 수 있습니다.
...
The app is distributed **exclusively through Google Play**. **0.1.28 (Alpha)** has been submitted for review and is awaiting Play availability. **0.1.22** is currently confirmed available. Join the testers group and opt in using the same Google account. See the [testing guide](docs/TESTING.md#english) and [release notes](https://github.com/hun99999/wipi-x-releases/releases).
